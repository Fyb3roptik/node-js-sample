...
<h2>Editing "<?php echo $PT->title; ?>" tab for product "<?php echo $P->name; ?>"</h2>
<form id="product_tab_form" action="/admin/tab/processTab/" method="post" enctype="multipart/form-data">
	<fieldset>
		<input type="hidden" name="product_tab_id" value="<?php echo $PT->ID; ?>" />
		<input type="hidden" name="product_id" value="<?php echo $PT->product_id; ?>" />
		Tab Type:<br />
		<?php
		$type_options = array(
		...
		or <a href="<? echo product_edit_url($P); ?>">Cancel</a>
	</fieldset>
</form>
