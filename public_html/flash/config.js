...
params.host                         = "chat.beastfranchise.com";
params.port                         = 6667;
...
params.autojoin                     = "#beastfranchise";
...
window.onbeforeunload = function() {
  swfobject.getObjectById('chatWindow').sendQuit();
}
